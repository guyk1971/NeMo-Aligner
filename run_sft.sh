...
python examples/nlp/gpt/train_gpt_sft.py \
   ...
   model.restore_from_path=./pretrained_mcore.nemo \
   model.optim.lr=5e-6 \
   ...
   exp_manager.wandb_logger_kwargs.project=gpt2_sft_run \
   exp_manager.wandb_logger_kwargs.name=gpt2_dolly_sft_run \
